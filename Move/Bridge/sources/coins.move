module dev::aexisVaultCoinsV3 {
    ...
    fun init_module(admin: &signer) acquires Tiers{
        ...
        add_tier(admin, 0, 1, 95, 1, 100_000_000, 75_000_000);
        add_tier(admin, 1, 5, 85, 10, 50_000_000, 20_000_000);
        add_tier(admin, 2, 10, 75, 20, 10_000_000, 7_000_000);
        add_tier(admin, 3, 15, 60, 40, 1_000_000, 500_000);
        add_tier(admin, 4, 25, 50, 80, 600_000, 250_000);
        add_tier(admin, 5, 40, 30, 125, 250_000, 100_000);
    }
