module QiaraVariablesReadV1::QiaraVariablesReadV1 {
    use QiaraVariablesReadV1::QiaraVariablesV1::{AdminCap, FriendCap, Registry};
    use sui::bcs;
    use std::string::{Self, String};
    // --- Getters ---
    public fun get_variable_to_u8(registry: &Registry, header: String, name: String): u8 {
        let mut data = QiaraVariablesReadV1::QiaraVariablesV1::get_variable(registry, header, name);
