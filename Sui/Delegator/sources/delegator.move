module QiaraDelegatorV1::QiaraDelegatorV1 {
    ...
    use std::vector;
    use QiaraMultiAssetVaultV1::QiaraMultiAssetVaultV1::{Self, AdminCap, Vault}; // this is the vault module
    use QiaraExtractorV1::QiaraExtractorV1::{Self as extractor};
