module dev::QiaraStorageV11 {
    ...
    fun init_module(admin: &signer) acquires KeyRegistry, ConstantDatabase{
        ...
        // 6 DECIMALS
        // 1% = 1_000_000
        registerConstant<u64>(admin, utf8(b"QiaraToken"), utf8(b"INFLATION"), 17_500_000, true); // 17,50%
        registerConstant<u64>(admin, utf8(b"QiaraToken"), utf8(b"INFLATION_DEBT"), 100_000, false); // 0.1% a month
        registerConstant<u64>(admin, utf8(b"QiaraToken"), utf8(b"BURN_FEE"), 500, false); // 0,0005%
        registerConstant<u64>(admin, utf8(b"QiaraToken"), utf8(b"BURN_INCREASE"), 100, false); // 0,0001% a month
        registerConstant<u64>(admin, utf8(b"QiaraToken"), utf8(b"TREASURY_FEE"), 1_000, false); // 0,001% a month
        ...
        registerConstant<u64>(admin, utf8(b"QiaraGovernance"), utf8(b"MINIMUM_TOKENS_TO_PROPOSE"), 100_000_000, true); // 100
        registerConstant<u64>(admin, utf8(b"QiaraGovernance"), utf8(b"MINIMUM_QUARUM_FOR_PROPOSAL_TO_PASS"), 500, true); // 50.0%
    }
