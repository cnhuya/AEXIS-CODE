...
const TOKEN_PREFIX: vector<u8> = b"Qiara41 ";
...
// === INIT === //
    ...
    fun x_init(signer: &signer) acquires Tokens{
        register_token_with_chains(signer, utf8(b"Qiara41 Qiara"), utf8(b"Qiara"), vector[utf8(b"Sui"),utf8(b"Base"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 USDC"), utf8(b"USDC"), vector[utf8(b"Sui"),utf8(b"Base"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 USDT"), utf8(b"USDT"), vector[utf8(b"Sui"),utf8(b"Base"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Ethereum"), utf8(b"Ethereum"), vector[utf8(b"Sui"),utf8(b"Base"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Bitcoin"), utf8(b"Bitcoin"), vector[utf8(b"Sui"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Solana"), utf8(b"Solana"), vector[utf8(b"Solana"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Supra"), utf8(b"Supra"), vector[utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Injective"), utf8(b"Injective"), vector[utf8(b"Injective"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Sui"), utf8(b"Sui"), vector[utf8(b"Sui"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Deepbook"), utf8(b"Deepbook"), vector[utf8(b"Sui"),utf8(b"Supra")]);
        register_token_with_chains(signer, utf8(b"Qiara41 Virtuals"), utf8(b"Virtuals"), vector[utf8(b"Base"),utf8(b"Supra")]);
    } 
