module dev::QiaraTokenTypesV4 {
    ...
    const TOKEN_PREFIX: vector<u8> = b"Qiara48 ";
...
fun x_init(signer: &signer) acquires Tokens {
    ...
    register_token_with_chains(signer, utf8(b"Qiara48 Qiara"), utf8(b"Qiara"), vector[utf8(b"0x8C9621E38f74c59b0B784894f12C0CD5bE8a2f02")], vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 USDC"), utf8(b"USDC"), vector[], vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 USDT"), utf8(b"USDT"), vector[], vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 Ethereum"), utf8(b"Ethereum"), vector[], vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Supra")]);
    
    // 2 chains -> 2 addresses
    register_token_with_chains(signer, utf8(b"Qiara48 Bitcoin"), utf8(b"Bitcoin"),vector[], vector[utf8(b"Sui"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 Solana"), utf8(b"Solana"), vector[], vector[utf8(b"Solana"), utf8(b"Supra")]);
    
    // 1 chain -> 1 address
    register_token_with_chains(signer, utf8(b"Qiara48 Supra"), utf8(b"Supra"), vector[], vector[utf8(b"Supra")]);
    
    // 2 chains -> 2 addresses
    register_token_with_chains(signer, utf8(b"Qiara48 Injective"), utf8(b"Injective"), vector[], vector[utf8(b"Injective"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 Sui"), utf8(b"Sui"), vector[], vector[utf8(b"Sui"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 Deepbook"), utf8(b"Deepbook"), vector[], vector[utf8(b"Sui"), utf8(b"Supra")]);
    
    register_token_with_chains(signer, utf8(b"Qiara48 Virtuals"), utf8(b"Virtuals"), vector[], vector[utf8(b"Base"), utf8(b"Supra")]);
}
