...
fun x_init(signer: &signer) acquires Tokens {
    ...
    register_token_with_chains(signer, utf8(b"Qiara61 Qiara"), utf8(b"Qiara"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara61 USDC"), utf8(b"USDC"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara61 USDT"), utf8(b"USDT"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara61 USDT0"), utf8(b"USDT0"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Supra")]);
    register_token_with_chains(signer, utf8(b"Qiara61 AUSD"), utf8(b"AUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Supra")]);
    register_token_with_chains(signer, utf8(b"Qiara61 earnAUSD"), utf8(b"earnAUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Supra")]);

    // Ethereum: 5 chains -> 5 placeholders
    register_token_with_chains(signer, utf8(b"Qiara61 Ethereum"), utf8(b"Ethereum"), 
        vector[utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Supra"), utf8(b"Monad"), utf8(b"Ethereum")]
    );
    
    // Bitcoin: 5 chains -> 5 placeholders
    register_token_with_chains(signer, utf8(b"Qiara61 Bitcoin"), utf8(b"Bitcoin"),
        vector[utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Monad"), utf8(b"Ethereum"), utf8(b"Base"), utf8(b"Supra")]
    );
    
    // Monad: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara61 Monad"), utf8(b"Monad"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Supra")]);
    
    // Supra: 1 chain -> 1 placeholder
    register_token_with_chains(signer, utf8(b"Qiara61 Supra"), utf8(b"Supra"), vector[utf8(b"0x0")], vector[utf8(b"Supra")]);
    
    // Sui & Deepbook: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara61 Sui"), utf8(b"Sui"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Supra")]);
    register_token_with_chains(signer, utf8(b"Qiara61 Deepbook"), utf8(b"Deepbook"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Supra")]);
    
    // Virtuals: 3 chains -> 3 placeholders
    register_token_with_chains(signer, utf8(b"Qiara61 Virtuals"), utf8(b"Virtuals"), 
