...
async function checkValidator(address) {
    ...
    try {
        const response = await fetch('https://rpc-testnet.supra.com/rpc/v3/view', {
            ...
            body: JSON.stringify({
                function: "0x6341ca6cd563e9317718102d312a2281fbb9b3e4506b4871d98dab4085f94ec1::QiaraVv32::return_parent",
                type_arguments: [],
...
async function get_epoch() {
    try {
        const response = await fetch('https://rpc-testnet.supra.com/rpc/v3/view', {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                function: "0x6341ca6cd563e9317718102d312a2281fbb9b3e4506b4871d98dab4085f94ec1::genesisV23::return_epoch",
                type_arguments: [],
                arguments: []
            })
        });
...
function startPolling(intervalMs = 5000) {
    ...
    const run = async () => {
        ...
        if (data.epoch !== epoch) {
            ...
            await build_input("validators", data);
...
async function get_validators_signatures(epoch) {
    try {
        const response = await fetch('https://rpc-testnet.supra.com/rpc/v3/view', {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                function: "0x6341ca6cd563e9317718102d312a2281fbb9b3e4506b4871d98dab4085f94ec1::Qiarax39::return_state",
                type_arguments: [],
