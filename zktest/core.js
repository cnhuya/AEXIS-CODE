...
//new e25755f077b9184646e8882d1705a0235651b58402f5ebd94f5b2a2ad124efa5
//6cb168ab2ba30211d0b0e52b16acfe1a9438457088732f66079c6635f00bea50
//nnn 76e4e301772698c31d08b42fd39551690c99b1c5689ed147c7ed4aa7f5f5eb6f
const privateKeyHex = "a5c37eb824028069f8ecad85133c77e6dbec32c52a9e809cff5d284c2e8526d2"; 
...
async function get_validators() {
    try {
        const response = await fetch('https://rpc-testnet.supra.com/rpc/v3/view', {
            ...
            body: JSON.stringify({
                function: "0x6341ca6cd563e9317718102d312a2281fbb9b3e4506b4871d98dab4085f94ec1::QiaraVv8::return_all_active_parents_full",
                type_arguments: [],
                arguments: []
            })
        });
...
async function get_validators_signatures(old_root) {
    ...
    try {
        const response = await fetch('https://rpc-testnet.supra.com/rpc/v3/view', {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                function: "0x6341ca6cd563e9317718102d312a2281fbb9b3e4506b4871d98dab4085f94ec1::Qiarax15::return_state",
                type_arguments: [],
