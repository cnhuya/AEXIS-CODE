...
fun x_init(signer: &signer) acquires Tokens {
    ...
    register_token_with_chains(signer, utf8(b"Qiara78 USDT0"), utf8(b"USDT0"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara78 AUSD"), utf8(b"AUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara78 earnAUSD"), utf8(b"earnAUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    ...
    register_token_with_chains(signer, utf8(b"Qiara78 Monad"), utf8(b"Monad"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    
    // Aptos: 1 chain -> 1 placeholder
    register_token_with_chains(signer, utf8(b"Qiara78 Aptos"), utf8(b"Aptos"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Aptos")]
    );
    
    // Sui & Deepbook: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara78 Sui"), utf8(b"Sui"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara78 Deepbook"), utf8(b"Deepbook"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
